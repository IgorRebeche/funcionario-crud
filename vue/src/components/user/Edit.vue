        ...
        <div class="col-md-12 form-wrapper">
          ...
          <form id="create-post-form" @submit.prevent="editUser">
            <div class="form-group col-md-12">
              ...
              <input type="text" id="name" v-model="user.name" name="title" class="form-control" placeholder="Enter name">
            </div>

            <div class="form-group col-md-12">
              <label for="title"> Age </label>
              <input type="text" id="age" v-model="user.age" name="title" class="form-control" placeholder="Enter age">
            </div>

            <div class="form-group col-md-12">
              <label for="title"> cpf </label>
              <input type="text" id="cpf" v-model="user.cpf" name="title" class="form-control" placeholder="Enter cpf">
            </div>
